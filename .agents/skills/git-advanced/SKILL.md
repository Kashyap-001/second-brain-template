...
git push --force-with-lease origin TASK-XXX-feature

# SAFE: Interactive rebase before first push
git rebase -i origin/main

# SAFE: Force push after conflict resolution on your own branch
git rebase origin/main && git push --force-with-lease origin TASK-XXX-feature
```
...
git add . && git commit -m "fix: address PR feedback [TASK-XXX]"
...
git log origin/TASK-XXX-feature..HEAD --oneline
