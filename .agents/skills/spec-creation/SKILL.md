...
> **TEMPLATE**: This skill uses `YOUR_VALUE` tokens. Replace with your project values before use.
...
## Logical Commits
1. `feat(scope): implement data model [TASK-{number}]`
2. `feat(scope): add API endpoint [TASK-{number}]`
3. `feat(scope): create UI component [TASK-{number}]`
4. `test(scope): add unit tests [TASK-{number}]`
```
...
| ------------ | --------------------------------------------------------- |
| Impl specs   | `specs/SPEC-TASK-{number}-{description}.md`  |
| Requirements | `docs/agent-outputs/requirements/TASK-*.md`  |
...
**Spec**: specs/SPEC-TASK-{number}-{description}.md
